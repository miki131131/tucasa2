            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a class="waves-effect waves-dark" href="Pricing.php">Login</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
if(isset($_POST['env'])){
	...
	/*if(mysqli_num_rows($res)>0){
		echo "El email que has introducido ya existe";
		return;
		}*/
	$sql = "INSERT INTO clientes (nombre, apellidos, email, contrasena) VALUES ('$nombre','$apellidos','$email','$password')";
	/*$sql = "INSERT INTO clientes (nombre, apellidos, email, contrasena) VALUES (%s,%s,%s,%s)";*/
