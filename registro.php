...
<!--<div id="wrapper"> -->
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                      ...
                      <!--  <li><a class="waves-effect waves-dark" href="portfolio.php">Galería</a></li>                       
                        ...
                        <li class="active"><a class="" href="#">Registro</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Datos de Registro</h2>
			</div>
		</div>
	</div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="nombre" value="" name="nombre" required autofocus
           placeholder="Introduce tu nombre">
  </div>
  <div class="form-group">
    <label for="apellidos">Apellidos</label>
    <input type="text" class="form-control" id="apellidos" value="" name="apellidos" required
 ...
 <fieldset>
        <legend>Que eres?</legend>
            ...
            <input type="radio" name="estado" value="C"> Comprador&nbsp;&nbsp;&nbsp;&nbsp;
               
            <input type="radio" name="estado" value="V"> Vendedor
...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	$sql = "SELECT email FROM tblclientes WHERE email='$email'";
	$res = $conn->prepare($sql);
	$res->bindParam(':email', $email, PDO::PARAM_STR);
	$res->execute();
	//var_dump($res);
	if($res->rowCount()>0){
echo "<div id='centrar'><div class='alert alert-danger'>El email introducido ya existe en nuestra base de datos.</div></div><p>&nbsp;</p>";
		return;
...
try {
    ...
    $sql1 = "INSERT INTO tblclientes (nombre, apellidos, email, contrasena) VALUES ('$nombre','$apellidos','$email','$password')";
	...
	if ($_POST['estado'] == "V" && $last_id != null)
		 	{
				echo $_POST['estado'];
